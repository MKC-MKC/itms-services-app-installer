<!-- scan -->
<div class="bloc full-width-bloc bloc-fill-screen tc-red" id="scan">
    ...
    <div class="container fill-bloc-bottom-edge">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-4 align-self-center col-lg-3">
                <div class="blockquote text-lg-center text-center container-div-scan-style">
                    <p class="mx-auto d-block text-lg-center p-style text-sm-center">Idea:&nbsp;<a class="ltc-red" href="https://linkbridge.ru/deep/?URL=tg://resolve?domain=user1man">@user1man</a></p>
                </div>
            </div>

            <div class="col-12 col-md-4 align-self-center col-lg-3">
                <div class="blockquote text-lg-center text-center">
                    <p class="text-lg-center mx-auto d-block p-style text-sm-center">Author:&nbsp;<a class="ltc-red" href="https://linkbridge.ru/deep/?URL=tg://resolve?domain=MiKillCrafter">@MiKillCrafter</a></p>
                </div>
            </div>
